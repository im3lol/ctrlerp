    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 bg-white/95 backdrop-blur-sm shadow-2xl shadow-black/20 rounded-2xl p-8 max-w-md w-full text-center">
          <div className="h-16 w-16 bg-gradient-to-bl from-[#7C3AED] to-[#F59E0B] rounded-2xl flex items-center justify-center shadow-lg shadow-[#7C3AED]/20 mx-auto mb-6 rotate-3 hover:rotate-0 transition-transform duration-300">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
            ...
            <p className="text-amber-600 text-xs">
              يتم حالياً إعداد خدمة إنشاء الحسابات. يرجى المحاولة لاحقاً أو التواصل مع المسؤول.
            </p>
          </div>
          <a href="/">
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 w-full max-w-md">
        ...
        <div className="text-center mb-2">
          ...
          <p className="text-slate-400 text-sm">إنشاء حساب جديد</p>
        </div>
